...
multiple Repositories is not automatic. See [Repositories](../../project-space/repositories/spec.md).
...
See [`specs/issue/decomposition/design.md`](design.md) for the design.
