...
behavior is defined in [`../specs/issue/decomposition/spec.md`](spec.md)
and repository rules in [`../specs/project-space/repositories/spec.md`](../../project-space/repositories/spec.md).
The decision result is recorded in
[`decisions/composite-issues.md`](../../../design/decisions/composite-issues.md).
...
- Dispatch carries no parent payload. A child Issue knows its parent through
  ...
  authority. See [`workflow/task-dispatch.md`](../../workflow/execution/design.md).
...
- Parent and child are separate Issue aggregates. A child terminal or reopen
  ...
  [`workflow/issue-coordination.md`](../../workflow/execution/design.md).
...
[`web-ui.md`](../../interfaces/web/design.md) owns exact parent-card placement by status, progress
