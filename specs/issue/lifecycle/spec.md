...
See [CLI Reference](../../interfaces/cli/spec.md#issue) for all options.
...
- Each Issue has one target Repository. Its branch, diff, and Integrate work
  ...
  [Repositories](../../project-space/repositories/spec.md).
- When one requirement spans multiple Repositories, split it into child Issues.
  ...
  Workflow. See [Composite Issues and Child Issues](../decomposition/spec.md).
...
[CLI Reference](../../interfaces/cli/spec.md#issue).
...
- GitHub mirror number, link, and sync health when the target Repository is
  connected. See [GitHub](../../integrations/github/issue-mirroring/spec.md).
...
automation. See [Core Concepts: Approval Point](../../workflow/execution/spec.md#approval-point).
...
See [CLI Reference](../../interfaces/cli/spec.md) for all edit options. Edit the body of an
active Issue with care because its Stage's Mohist Agent may already be working
from the previous body.

## Complete CLI Reference

See the Issue section in [CLI Reference](../../interfaces/cli/spec.md) for the authoritative
...
own Workflow. See [Composite Issues and Child Issues](../decomposition/spec.md).

See [Issue Management](spec.md).
