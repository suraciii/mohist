...
See [`event-protocol.md`](../../platform/events/spec.md) for event protocol and stamping.
See [`agent-execution.md`](../../agent/execution/design.md) and
[`event-routing.md`](../../agent/event-routing/design.md) for launch, AgentJob, and AgentSession.
...
`mo issue watch add`; see [`issue-watch.md`](../../agent/supervision/design.md).
...
[`event-response.md`](../../agent/event-routing/design.md). It lets the event path distinguish a
