...
[github-integration.md](../../integrations/github/issue-mirroring/design.md). Slack member policy belongs to
the [Agent Connection security boundary](../../integrations/slack/connections/design.md#security-boundary). Direct External Agent
access builds on this model and is defined further in [agent-api.md](../../interfaces/agent-api/design.md).
...
belong to [agent-api.md](../../interfaces/agent-api/design.md).
...
[agent-api.md](../../interfaces/agent-api/design.md).
