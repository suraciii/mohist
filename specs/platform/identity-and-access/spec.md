...
See [GitHub](../../integrations/github/issue-mirroring/spec.md) and [Slack](../../integrations/slack/enrollment/spec.md).
...
The [External Agent API](../../interfaces/agent-api/spec.md) supports headless callers that launch or
...
API](../../interfaces/agent-api/spec.md).
