...
[`runner-environment.md`](../environment/design.md). This document remains the
...
[`event-protocol.md`](../../platform/events/spec.md#historical-workflow-interruption-events).
...
([`conventions.md`](../../../design/conventions.md#facts-claims-and-settlement)). An AgentJob
...
- Result preservation through Runtime session adoption: asking the Runtime for
  ...
  ([`conventions.md`](../../../design/conventions.md#facts-claims-and-settlement)).
...
recorded in
[`decisions/volatile-runtime-event-evidence.md`](../../../design/decisions/volatile-runtime-event-evidence.md).
