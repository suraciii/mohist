...
integration reliable. Product behavior is in [`specs/integrations/github/issue-mirroring/spec.md`](spec.md).
The GitHub PR Action family is defined in
[`workflow/actions.md`](../../../workflow/actions/design.md) and
[`specs/workflow/actions/github-pr/spec.md`](../../../workflow/actions/github-pr/spec.md).
