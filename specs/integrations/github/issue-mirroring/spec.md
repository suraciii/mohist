...
reach Mohist as real-time events and can feed [Event routing](../../../agent/event-routing/spec.md).
...
See [`specs/integrations/github/issue-mirroring/design.md`](design.md) for
