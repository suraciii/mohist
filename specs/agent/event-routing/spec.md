...
uses the same commands as a human owner. See [Agents and AgentSessions](../execution/spec.md)
for Agent execution and [Event Protocol](../../platform/events/spec.md) for event
...
`mo agent install supervisor`. See [Agent Supervision](../supervision/spec.md).
