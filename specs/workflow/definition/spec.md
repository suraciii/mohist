...
WorkflowRun. See [Workflow Profile](../profiles/spec.md) for Profile selection
and management.
...
work. See [Core Concepts: Approval Point](../execution/spec.md#approval-point) for the
...
See [Core Concepts: Approval Point](../execution/spec.md#approval-point) for available
...
invalid input. See [Action Contracts](../actions/spec.md) for Action inputs and
outputs.
...
see [Workspace](../../workspace/lifecycle/spec.md#layout). Runner derives the same Repository
...
- `vars.*`: merged Variables. See [Variable References](../profiles/spec.md#variable-references).
