...
reference [`specs/workflow/definition/spec.md`](spec.md)
...
[`actions.md`](../actions/design.md) and [`task-dispatch.md`](../execution/design.md) for the
...
- Execution state such as `recoveryRemaining`, attempts, or task output. See
  [`recovery.md`](../execution/design.md).
...
[`docs/concepts.md`](../execution/spec.md#approval-point) is authoritative
