...
[`../decisions/workflow-agent-binding.md`](../../../design/decisions/workflow-agent-binding.md)
for the `mohist/agent` binding and [`runner.md`](../../runner/work-confirmation/design.md#report) for the
report boundary.
...
[`task-dispatch.md`](../execution/design.md) owns rendering timing and attempt
snapshot semantics.
...
1. Clone `with` from the attempt snapshot. Preserve fields declared
   ...
   contract; see [`task-dispatch.md`](../execution/design.md).
...
[`../runner.md`](../../runner/work-confirmation/design.md#report).
...
- Runner uses the Run Variables PATCH API with a body containing only `vars`.
  See [`variables.md`](../variables/spec.md) for complete semantics.
...
input. See the
[product reference](../definition/spec.md#expect-completion-requirements)
...
[`recovery.md`](../execution/design.md) for recovery design.
...
in their owning models. See [`../runtimes/opencode.md`](../../interfaces/runtimes/opencode/design.md)
...
[`plan-artifacts.md`](../execution/design.md) for the persistence boundary.
...
repair. See [`builtin-workflows.md`](../profiles/design.md) for the complete
task graph.
