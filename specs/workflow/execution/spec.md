...
and recovery therefore stay focused on one uncertain boundary. See [Issue Management](../../issue/lifecycle/spec.md) for Issue
operations and [Workflow Profile](../profiles/spec.md) for custom stages, tasks, and approval policies.

Every Stage stores artifacts as evidence for later decisions and audits. See [Plan Artifacts](design.md) for the
artifact contract.
...
the task list. See [Workspace](../../workspace/lifecycle/spec.md#layout) for the layout and [Plan Artifacts](design.md) for persistence and recovery.
...
authorized actor may approve or request changes. See [Core Concepts: Approval Point](#approval-point) for the feedback sequence and
ownership rules.
...
[Workflow Definition Reference](../definition/spec.md) for the fields.
...
diff before a manual decision. See [Core Concepts: Approval Point](#approval-point) for the complete sequence.
...
The Issue becomes blocked and waits for intervention. See [Troubleshooting](../../../docs/troubleshooting.md).
...
require an Approval Point after Build, skip Check, or add a Stage such as Deploy. [Workflow Definition Reference](../definition/spec.md)
defines Profile fields and validation. See [Workflow Profile](../profiles/spec.md) for Profile selection.
## Approval Point
...
dispatch-time behavior. See [Workflow Profile](../profiles/spec.md) and
[Workflow Definition Reference](../definition/spec.md).
...
presentation alias. See [Authentication and Access](../../platform/identity-and-access/spec.md).
