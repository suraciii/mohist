...
the [scheduled-input specification](spec.md#scheduled-input-1).
The `AgentSession`, `SessionInput`, `AgentTurn`, and binding lifecycles remain
authoritative in [Session inputs and Turns](../input-and-turns/design.md) and
[Session recovery](../recovery/design.md).
...
- **Runtime Session definitely absent while idle:** establish a binding through
  [automatic recovery](../recovery/design.md#runtime-session-missing-recovery), then
  deliver.
...
[`subagents.md#scheduled-input-interaction`](../subagents/design.md#scheduled-input-interaction).
