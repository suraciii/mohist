...
the [transcript contract](#transcript-contract) and
[Session invariants](../input-and-turns/design.md#agentsession-invariants).
Product behavior is defined in the [Session timeline specification](spec.md#session-timeline).
