...
Product behavior is defined in the [subagent specification](spec.md).
The base lifecycles of `AgentJob`, `AgentSession`, `SessionInput`, and
`AgentTurn` remain defined in [Agent execution](../../agent/execution/design.md) and
[Session inputs and Turns](../input-and-turns/design.md). This
...
Its design is authoritative in [`scheduled-input.md`](../scheduled-input/design.md). This
...
[`scheduled-input.md`](../scheduled-input/design.md). A parent may create a schedule for
...
- Do not accept `--work-dir`, `workspacePath`, a named Workspace override, or any
  ...
  parent Workspace ([`workspaces.md`](../../workspace/lifecycle/design.md)).
