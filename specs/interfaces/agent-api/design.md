...
[`../specs/interfaces/agent-api/spec.md`](spec.md). This design owns idempotency,
...
- [Agent execution](../../agent/execution/design.md) owns AgentJob execution.
  [Session inputs and Turns](../../session/input-and-turns/design.md) define
  AgentSession, SessionInput, AgentTurn, admission, and launch convergence.
  [Session recovery](../../session/recovery/design.md) defines Binding recovery.
- [Conventions](../../../design/conventions.md) owns canonical internal read shapes and effect
  fences.
- [Authentication and identity](../../platform/identity-and-access/design.md) owns PAT identity, scopes, and Project
  grants.
- The [product API reference](spec.md) owns routes, public fields,
  request and response shapes, and error codes.
- [Subagent cascade stop](../../session/subagents/design.md#cascade-stop) owns product-level root
...
The public route catalog in [`../specs/interfaces/agent-api/spec.md`](spec.md)
...
lifecycle remain authoritative in [auth.md](../../platform/identity-and-access/design.md#externalagentcaller).
...
[launch convergence](../../session/input-and-turns/design.md#launch-convergence). The API must not claim that a combined
...
[External Agent API](spec.md#projection-freshness-and-errors) owns
...
[subagents.md](../../session/subagents/design.md#cascade-stop); neither route makes Session terminal.
...
projection](../../../design/conventions.md#canonical-sessionoperationread) and [effect
fence](../../../design/conventions.md#canonical-effect-fence).
