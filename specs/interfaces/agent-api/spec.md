...
[Agents and AgentSessions](../../agent/configuration/spec.md#execution-resolution).
...
See [External Agent API design](design.md#normalized-fingerprint-and-idempotency)
...
later Turn. See [External Agent API design](design.md#five-state-mapping-and-precedence)
...
- The unified invocation interface lacks caller-owned duplicate-request
  ...
  external clients. See [`specs/interfaces/agent-api/design.md`](design.md).
