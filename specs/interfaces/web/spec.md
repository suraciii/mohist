...
[AgentOps activity](../../agent-ops/activity/spec.md), including fleet
...
See
[Agents and AgentSessions](../../agent/configuration/spec.md#model-effort-and-variant-selection).
...
See [Planning with Epics](../../issue/epics/spec.md) for action availability and transitions.
...
See [Workflow Profiles](../../workflow/profiles/spec.md) and [Runner Guide](../../runner/presence-and-capacity/spec.md).
