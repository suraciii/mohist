...
one deep module. [Agent execution](../../../agent/execution/design.md),
[Session inputs and Turns](../../../session/input-and-turns/design.md), and
[Session recovery](../../../session/recovery/design.md) remain authoritative for
AgentJob, AgentSession, and shared binding rules.
...
[`../workflow/actions.md`](../../../workflow/actions/design.md). `prompt` is rendered to
non-empty text by [`../workflow/task-dispatch.md`](../../../workflow/execution/design.md);
...
in [`agent-execution.md`](../../../session/recovery/design.md#runtime-session-missing-recovery).
...
[`agent-execution.md`](../../../session/transcript/design.md#activity-and-transcript). The
