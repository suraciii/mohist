...
capability. [Agent execution](../../../agent/execution/design.md) and
[Session inputs and Turns](../../../session/input-and-turns/design.md) own Agent
and Session lifecycle rules.

The Runtime specifications define Runtime-specific process lifecycle, provider mapping,
physical Session behavior, event projection, state verification, and
compatibility boundaries.

- [OpenCode](../opencode/design.md) defines `OpenCodeRuntime`, its SDK and local Server,
  physical Session lifecycle, Prompt execution, and Session commands.
- [Pi](../pi/design.md) defines `PiRuntime`, its in-process SDK, physical Session-file
  lifecycle, Prompt execution, and Session commands. Pi is an independent peer,
  not an OpenCode extension.
- [Codex](../codex/design.md) defines `CodexRuntime`, its app-server v2 process and
...
- [`../workflow/actions.md`](../../../workflow/actions/design.md) defines Workflow Action
  dispatch and input/output contracts.
- [`../../docs/actions/`](../../../workflow/actions/spec.md) defines the user-facing
  Action contracts.
