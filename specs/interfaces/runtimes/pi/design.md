...
and event details inside one deep module. [Agent execution](../../../agent/execution/design.md),
...
[`../workflow/actions.md`](../../../workflow/actions/design.md). Pi uses the same input
shape, expansion timing, and output projection as `mohist/opencode`; see
[`opencode.md`](../opencode/design.md).
...
[`agent-execution.md`](../../../session/recovery/design.md#runtime-session-missing-recovery).
...
[`agent-execution.md`](../../../session/transcript/design.md#activity-and-transcript). Each
