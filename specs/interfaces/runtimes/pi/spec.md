...
> [`mohist/agent`](../../../workflow/actions/agent/spec.md), not this Action directly.

`mohist/pi` delegates one unit of work to Pi and reports the execution facts.
It is a peer of [`mohist/opencode`](../opencode/spec.md). A Workflow selects one
...
See [Agents and AgentSessions](../../../agent/execution/spec.md) for the overall
...
[`mohist/opencode`](../opencode/spec.md) basic usage. The same `agent` object can bind
...
[Action Contracts](../../../workflow/actions/spec.md#shared-semantics-for-agent-execution-actions).
