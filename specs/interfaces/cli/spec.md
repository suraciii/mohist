...
[Workspace](../../workspace/lifecycle/spec.md) for product semantics. The CLI creates, changes
...
- `mo session schedule create <session-id> --at <time> --text <text> [--idempotency-key <key>]`
  ...
  [Subagents and Session Trees](../../session/subagents/spec.md) for the scheduled-input contract.
...
[Subagents and Session Trees](../../session/subagents/spec.md#lifecycle).
...
Slack. CLI and Web operate the same integration record. See [Slack](../../integrations/slack/enrollment/spec.md)
...
See [GitHub](../../integrations/github/issue-mirroring/spec.md) for the complete product semantics.
