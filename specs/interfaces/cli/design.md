...
[`specs/interfaces/cli/spec.md`](spec.md) is the sole authority for
...
- `specs/interfaces/cli/spec.md` owns target product semantics and user-facing command
  behavior.
...
- `workspace create`, `list`, `view`, and `close` manage Workspaces.
  ...
  [`workspaces.md`](../../workspace/lifecycle/design.md).
...
- `session transcript`, `followup`, `compact`, `reset`, and `stop` operate on
  ...
  [`subagents.md#cascade-stop`](../../session/subagents/design.md#cascade-stop).
...
see [`agent-operability.md`](../agent-operability/design.md#failures-at-the-cli).
...
[`specs/interfaces/cli/spec.md`](spec.md#implementation-gaps). The
