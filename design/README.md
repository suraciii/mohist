...
- [runner-restart.md](runner-restart.md) — Runner restart and report settlement: stateless Runner, process-generation closeout, in-memory report retry, ordinary-failure crash semantics.
