...
- [testing.md](testing.md) — Unit, Spec, Browser, and Architecture tracks; external dependencies, time dependencies, and fake entry points. Gate run-directory, DAG, and lane internals live in [`../scripts/test-duration/README.md`](../scripts/test-duration/README.md).
