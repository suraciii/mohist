...
The product contract lives in [`../docs/agent-operability.md`](../docs/agent-operability.md);
user-visible syntax, fields, and error text live in
[`../docs/cli-reference.md`](../docs/cli-reference.md). This document records why the
...
([`agent-api.md`](agent-api.md#normalized-fingerprint-and-idempotency)); the
