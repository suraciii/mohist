...
[the CLI reference](cli-reference.md), and the rules an implementation must
preserve live in [the design note](../design/agent-operability.md).
...
- [Agent Supervision](agent-supervision.md)
- [External Agent API](agent-api.md)
- [The Workflow](the-workflow.md)
