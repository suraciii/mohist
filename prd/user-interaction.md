...
```
Explore       ████████ 高   AI 面试你，你理清需求
Plan gate     ████ 中       审查方案+任务拆分
Build         █ 低          AI 自己写，你忙别的
Check gate    ████ 中       审查结果
Integrate     █ 低          AI 自动合并归档
```
...
打开 `http://localhost:3456`，在看板和活动页面实时查看进度。
...
```bash
mo issue approve 42    # Plan gate：确认方案和任务拆分
mo issue approve 42    # Check gate：确认最终结果
```
