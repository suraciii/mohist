...
if not agent_exists:
    test_agent = {
        "id": "crawlph-test",
        "workspace": "/home/user/repos/crawlph-test",
        "agentDir": "/home/user/.openclaw/agents/crawlph-test",
        "model": "zai/glm-5",
        "sandbox": {"mode": "off"}
    }
...
import os
data_dirs = [
    '/home/user/.openclaw/agents/crawlph-test',
    '/home/user/.openclaw/agents/crawlph-test/data',
    '/home/user/.openclaw/agents/crawlph-test/data/progress'
]
