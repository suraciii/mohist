...
- [context-management.md](context-management.md) — Context management: what the
  ...
  rules.
- [testing.md](testing.md) — Tests as executable Specs: Kind, Level, and
  Resources, ownership-based placement, hermetic resources, local validation
  commands, and the final Gate.
