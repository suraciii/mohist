...
- Publish the Skill's stable name, version, instructions, and content digest from Server as part of the Slack execution context, and require the Runner to validate the context before invoking a Runtime.
...
- `slack-collaboration-skill`: Defines the canonical six Slack collaboration rules, their direct-question and silent-recovery behavior, their correspondence with the Slack product documentation, and the versioned name/instructions/content-digest integrity contract.
