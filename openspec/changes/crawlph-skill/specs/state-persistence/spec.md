...
The system SHALL persist state to files in /data/.clawdbot/.
...
- **THEN** system SHALL store in crawlph-progress/issue-{N}.json
...
- **WHEN** reading crawlph-progress/issue-{N}.json
- **THEN** format SHALL be:
  ```json
  {
    "issueNumber": 123,
