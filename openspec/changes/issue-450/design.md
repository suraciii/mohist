...
- RunnerHost tests use fake timers to cover pre-registration runtime/storage readiness, empty catalog, retry/recovery, polling suppression, and continued result-ack drain. Web tests cover Pi inline-Agent classification, milestones, and every supplied usage dimension.
