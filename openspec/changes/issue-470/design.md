...
3. Replace the one-shot initializer with the enabled-only continuous process/storage sampler and observable resource gauges, reusing the same production probe; never register both hosted services.
