...
- **No DB schema changes**: `EpicIssueRow` already persists independently of epic status; no migration needed (existing terminal epics have empty link sets today, which remains valid).
