...
- `PLAYWRIGHT_CHROMIUM_EXECUTABLE=/home/mohist/.cache/ms-playwright/chromium-1223/chrome-linux64/chrome npm run test:e2e` passed: 10 tests, including collapsed stage-model reveal and empty-repository add-form focus.
