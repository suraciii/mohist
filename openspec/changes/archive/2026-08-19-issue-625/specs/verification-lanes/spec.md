...
- **THEN** the lane script exports `DOTNET_ROOT=/home/user/.dotnet` before invoking `dotnet test Mohist.sln --nologo -m:1 -p:UseSharedCompilation=false`
