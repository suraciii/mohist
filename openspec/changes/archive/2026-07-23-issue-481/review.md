...
- `DOTNET_ROOT=/home/user/.dotnet dotnet test packages/cli/tests/Mohist.Cli.Tests/Mohist.Cli.Tests.csproj --nologo` passed: 1431 tests.
- `DOTNET_ROOT=/home/user/.dotnet dotnet test packages/server/tests/Mohist.Server.SpecTests/Mohist.Server.SpecTests.csproj --nologo` passed: 3022 tests.
