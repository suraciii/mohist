...
- **AND** the widget SHALL source colors from theme tokens, route states through the shared three-state wrapper, expose the accessibility wrapper, and apply the tabular-nums and transform-based motion conventions
