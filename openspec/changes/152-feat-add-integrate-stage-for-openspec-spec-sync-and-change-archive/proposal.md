...
- **Current implementation progress**: T-001 has landed the initial `OpenSpecIntegrator` service and focused unit tests. Subsequent tasks should wire it into Check readiness and Integrate execution rather than changing the service contract opportunistically.
