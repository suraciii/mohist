...
public sealed record TaskReport(
    ...
    [property: Id(9)] WorkflowTaskCompletionBoundary? CompletionBoundary = null,
    [property: Id(10)] string? WorkspaceOutcome = null,
    [property: Id(11)] string? WorkspaceReason = null);
