...
/// <summary>
/// Persists workflow CloudEvents 1.0.2 envelopes to the
/// <c>WorkflowRunEvents</c> table. Storage shape is the envelope itself,
/// not the raw <c>WorkflowEvent</c> payload, so reads and writes share
/// the same on-disk structure as the bus dispatch path.
/// </summary>
