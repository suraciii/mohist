...
public partial class AddSlackS2PortsManifestRotation : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.AddColumn<string>("S2OriginalManagerTransportKind", "SlackWorkspaceEnrollments", "TEXT", maxLength: 32, nullable: false, defaultValue: "socket");
        migrationBuilder.DropCheckConstraint("CK_SlackWorkspaceEnrollments_ManagerTransportKind", "SlackWorkspaceEnrollments");
        migrationBuilder.Sql("""
            UPDATE "SlackWorkspaceEnrollments"
            SET "S2OriginalManagerTransportKind" = "ManagerTransportKind",
                "ManagerTransportKind" = CASE WHEN "ManagerTransportKind" = 'https' THEN 'socket' ELSE "ManagerTransportKind" END,
                "ManagerReadiness" = CASE WHEN "ManagerTransportKind" = 'https' THEN 'not_ready' ELSE "ManagerReadiness" END;
            """);
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.Sql("UPDATE \"SlackWorkspaceEnrollments\" SET \"ManagerTransportKind\" = \"S2OriginalManagerTransportKind\";");
        migrationBuilder.DropColumn("S2OriginalManagerTransportKind", "SlackWorkspaceEnrollments");
    ...
    private static void RebuildSqliteTables(MigrationBuilder migrationBuilder, bool includeHttpsColumns)
    {
        ...
        var enrollmentColumns = includeHttpsColumns
            ...
            : "\"Id\", \"WorkspaceTeamId\", \"Lifecycle\", \"ManagerCapability\", \"CapabilityReason\", \"LastVerifiedAt\", \"PlanCode\", \"ManagedAppLimit\", \"ConfigurationCredentialRef\", \"ConfigurationCredentialGeneration\", \"ConfigurationCredentialExpiresAt\", \"S2OriginalManagerTransportKind\", \"ManagerCredentialRef\", \"ManagerAppId\", \"ManagerBotUserId\", \"ManagerTransportKind\", \"ManagerReadiness\", \"ManagerActorId\", \"ClaimedSlackUserId\", \"ManagerClaimHash\", \"ManagerClaimIssuedAt\", \"ManagerClaimExpiresAt\", \"ManagerClaimConsumedAt\", \"AuditJson\", \"CreatedAt\", \"UpdatedAt\", \"DeletedAt\"";
        var enrollmentSelect = includeHttpsColumns
            ? "\"Id\", \"WorkspaceTeamId\", \"Lifecycle\", \"ManagerCapability\", \"CapabilityReason\", \"LastVerifiedAt\", \"PlanCode\", \"ManagedAppLimit\", \"ManagerCredentialRef\", \"ManagerAppId\", \"ManagerBotUserId\", \"S2OriginalManagerTransportKind\", \"ManagerReadiness\", \"ManagerActorId\", \"ClaimedSlackUserId\", \"ManagerClaimHash\", \"ManagerClaimIssuedAt\", \"ManagerClaimExpiresAt\", \"ManagerClaimConsumedAt\", \"AuditJson\", \"CreatedAt\", \"UpdatedAt\", \"DeletedAt\""
            : "\"Id\", \"WorkspaceTeamId\", \"Lifecycle\", \"ManagerCapability\", \"CapabilityReason\", \"LastVerifiedAt\", \"PlanCode\", \"ManagedAppLimit\", '', 0, NULL, \"ManagerTransportKind\", \"ManagerCredentialRef\", \"ManagerAppId\", \"ManagerBotUserId\", CASE WHEN \"ManagerTransportKind\" = 'https' THEN 'socket' ELSE \"ManagerTransportKind\" END, CASE WHEN \"ManagerTransportKind\" = 'https' THEN 'not_ready' ELSE \"ManagerReadiness\" END, \"ManagerActorId\", \"ClaimedSlackUserId\", \"ManagerClaimHash\", \"ManagerClaimIssuedAt\", \"ManagerClaimExpiresAt\", \"ManagerClaimConsumedAt\", \"AuditJson\", \"CreatedAt\", \"UpdatedAt\", \"DeletedAt\"";
        var configurationCredentialDefinitions = includeHttpsColumns
            ? string.Empty
            : ", \"ConfigurationCredentialRef\" TEXT NOT NULL, \"ConfigurationCredentialGeneration\" INTEGER NOT NULL, \"ConfigurationCredentialExpiresAt\" TEXT NULL, \"S2OriginalManagerTransportKind\" TEXT NOT NULL DEFAULT 'socket'";
        migrationBuilder.Sql($"""
