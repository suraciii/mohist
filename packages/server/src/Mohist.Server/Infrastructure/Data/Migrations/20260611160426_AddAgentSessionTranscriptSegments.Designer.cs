...
namespace Mohist.Server.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260611160426_AddAgentSessionTranscriptSegments")]
    partial class AddAgentSessionTranscriptSegments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mohist.Server.Infrastructure.Data.Sessions.AgentSessionTranscriptSegmentRow", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("SessionId", "Kind", "CorrelationId");

                    b.HasIndex("WorkflowRunId", "SessionName", "Sequence");

                    b.ToTable("AgentSessionTranscriptSegments", (string)null);
                });
