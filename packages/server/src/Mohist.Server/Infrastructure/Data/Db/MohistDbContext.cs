...
protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        ConfigureGitHubModels(modelBuilder);
        ...
        modelBuilder.Entity<StoredSecretRow>(entity =>
        {
            ...
            entity.ToTable(t => t.HasCheckConstraint(
                ...
                "\"OwnerKind\" IN ('agent_connection', 'webhook_subscription', 'slack_workspace_enrollment', 'managed_slack_agent_app', 'github_connection', 'server')"));
            entity.ToTable(t => t.HasCheckConstraint(
                "CK_StoredSecrets_Kind",
                "\"Kind\" IN ('appToken', 'botToken', 'webhookSecret', 'clientSecret', 'signingSecret', 'configurationAccessToken', 'configurationRefreshToken', 'previousBotToken', 'previousAppToken', 'candidateBotToken', 'candidateAppToken', 'publicApiCursorKey', 'githubAppCredential')"));
            entity.ToTable(t => t.HasCheckConstraint(
                ...
                "(\"OwnerKind\" = 'server' AND \"Kind\" IN ('publicApiCursorKey', 'githubAppCredential'))"));
