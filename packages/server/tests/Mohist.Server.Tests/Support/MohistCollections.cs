...
using Mohist.Server.Tests.Events;
using Mohist.Server.Tests.Agent.Grain;
using Mohist.Server.Tests.Workflow;
using Mohist.Server.Tests.Workflow.Grain;
using Mohist.Server.Tests.Slack;
using Mohist.Server.Tests.GitHub;
using Mohist.Server.Tests.Runner.Api;
using Xunit;

[assembly: AssemblyFixture(typeof(Mohist.Server.Tests.Support.DefaultApplicationHostOwner))]
...
public class RepositoryDataUpgradeCollection
    : ICollectionFixture<Issue.Api.RepositoryDataUpgradeFixture>;
...
public class IntegrationTelemetryCollection : ICollectionFixture<Telemetry.OtlpRoutesHostFixture>;
