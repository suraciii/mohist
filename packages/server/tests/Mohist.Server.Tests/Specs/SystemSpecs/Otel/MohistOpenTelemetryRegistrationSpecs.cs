...
public class MohistOpenTelemetryRegistrationSpecs
{
    ...
    public void Enabled_ActivityListenerSeesActivityStartedWhileProviderIsAlive()
    {
        ...
        {
            ShouldListenTo = source => source.Name == "Mohist.Server.Tests.Specs.SystemSpecs.Otel",
        ...
        using var activitySource = new ActivitySource("Mohist.Server.Tests.Specs.SystemSpecs.Otel");
