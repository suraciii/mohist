...
public class IssueQuerierSpecs
{
    ...
    public async Task GetDeliveryTimesAsync_DeliveredIssue_ReturnsLeadAndCycleDurations()
    {
        ...
        var issue = SeedDeliveredIssue(
            ...
            createdAt: createdAt,
            completedAt: completedAt);
        SeedEvent(db, issue.Id, IssueQuerier.WorkStartedType, workStartedAt);
        await db.SaveChangesAsync();
    ...
    public async Task GetDeliveryTimesAsync_GenuineZeroDurationCycle_ReportsZero()
    {
        ...
        SeedEvent(db, issue.Id, IssueQuerier.WorkStartedType, new DateTimeOffset(zeroMoment, TimeSpan.Zero));
        await db.SaveChangesAsync();
    ...
    public async Task GetStageDurationsAsync_MultiRunLatestAttempt_UsesLastAttemptPerStage()
    {
        ...
        SeedEvent(db, issue.Id, IssueQuerier.WorkStartedType, new DateTimeOffset(2026, 6, 3, 10, 0, 0, TimeSpan.Zero), workflowRunId: "wr_sd_multirun");
        await db.SaveChangesAsync();
    ...
    public async Task GetStageDurationsAsync_CrossRunLatestPair_TakesLatestFromMostRecentRun()
    {
        ...
        SeedEvent(db, issue.Id, IssueQuerier.WorkStartedType, new DateTimeOffset(2026, 6, 3, 10, 0, 0, TimeSpan.Zero), workflowRunId: "wr_sd_first");
        SeedEvent(db, issue.Id, IssueQuerier.WorkStartedType, new DateTimeOffset(2026, 6, 6, 10, 0, 0, TimeSpan.Zero), workflowRunId: "wr_sd_second");
        await db.SaveChangesAsync();
    ...
    public async Task GetStageDurationsAsync_DuplicateCompletion_UsesFirstCompletionAfterLatestStart()
    {
        ...
        SeedEvent(db, issue.Id, IssueQuerier.WorkStartedType, completedAt.AddHours(-6), workflowRunId: "wr_sd_duplicate_complete");
        await db.SaveChangesAsync();
    ...
    public async Task GetStageDurationsAsync_StartedButNeverCompleted_ExcludedFromAverage()
    {
        ...
        SeedEvent(db, issue.Id, IssueQuerier.WorkStartedType, new DateTimeOffset(2026, 6, 3, 10, 0, 0, TimeSpan.Zero), workflowRunId: "wr_sd_undef");
        await db.SaveChangesAsync();
    ...
    public async Task GetStageDurationsAsync_SumToCycleDecomposition_HoldsForDeliveredIssue()
    {
        ...
        SeedEvent(db, issue.Id, IssueQuerier.WorkStartedType, firstWorkStart, workflowRunId: workflowRunId);
        await db.SaveChangesAsync();
    ...
    public async Task GetStageDurationsAsync_PopulationWeightedRatio_NotArithmeticMean()
    {
        ...
        SeedEvent(db, issueA.Id, IssueQuerier.WorkStartedType, completedAtBase.AddDays(-2).AddHours(-10), workflowRunId: "wr_sd_weighted_a");
        SeedEvent(db, issueB.Id, IssueQuerier.WorkStartedType, completedAtBase.AddDays(-1).AddHours(-20), workflowRunId: "wr_sd_weighted_b");
        await db.SaveChangesAsync();
    ...
    public async Task GetStageDurationsAsync_WaitBreakoutAverages_ZeroWaitContributesZero()
    {
        ...
        SeedEvent(db, issueA.Id, IssueQuerier.WorkStartedType, completedAtBase.AddDays(-2).AddHours(-10), workflowRunId: "wr_sd_wait_a");
        SeedEvent(db, issueB.Id, IssueQuerier.WorkStartedType, completedAtBase.AddDays(-1).AddHours(-10), workflowRunId: "wr_sd_wait_b");
        await db.SaveChangesAsync();
    ...
    public async Task GetStageDurationsAsync_ApprovalWaitGreaterThanStageSpan_ExcludesIssueFromCycleAggregates()
    {
        ...
        SeedEvent(db, issue.Id, IssueQuerier.WorkStartedType, completedAt.AddHours(-3), workflowRunId: "wr_sd_invalid_wait");
        await db.SaveChangesAsync();
    ...
    public async Task GetStageDurationsAsync_StageSpanGreaterThanCycle_ExcludesIssueFromCycleAggregates()
    {
        ...
        SeedEvent(db, issue.Id, IssueQuerier.WorkStartedType, completedAt.AddHours(-1), workflowRunId: "wr_sd_invalid_stage");
        await db.SaveChangesAsync();
    ...
    public async Task GetStageDurationsAsync_GenuineZeroDurationStage_DistinctFromEmpty()
    {
        ...
        SeedEvent(db, issue.Id, IssueQuerier.WorkStartedType, new DateTimeOffset(zeroMoment, TimeSpan.Zero), workflowRunId: "wr_sd_zero");
        await db.SaveChangesAsync();
    ...
    public async Task GetStageDurationsAsync_CompletedBeyond30Days_ExcludedFromWindow()
    {
        ...
        SeedEvent(db, inside.Id, IssueQuerier.WorkStartedType, new DateTimeOffset(2026, 6, 18, 9, 0, 0, TimeSpan.Zero), workflowRunId: "wr_sd_window_inside");
        await db.SaveChangesAsync();
        ...
        SeedEvent(db, outside.Id, IssueQuerier.WorkStartedType, new DateTimeOffset(2026, 5, 19, 9, 0, 0, TimeSpan.Zero), workflowRunId: "wr_sd_window_outside");
        await db.SaveChangesAsync();
    ...
    public async Task GetStageDurationsAsync_DeliveredIssuesInOtherProject_NotInStages()
    {
        ...
        SeedEvent(db, insideA.Id, IssueQuerier.WorkStartedType, new DateTimeOffset(completedAt.AddHours(-2), TimeSpan.Zero), workflowRunId: "wr_sd_scope_a");
        SeedEvent(db, insideB.Id, IssueQuerier.WorkStartedType, new DateTimeOffset(completedAt.AddHours(-4), TimeSpan.Zero), workflowRunId: "wr_sd_scope_b");
        await db.SaveChangesAsync();
    ...
    public async Task GetStageDurationsAsync_StagesOrderedByWorkflowStageOrder()
    {
        ...
        SeedEvent(db, issue.Id, IssueQuerier.WorkStartedType, completedAt.AddHours(-10), workflowRunId: "wr_sd_order");
        await db.SaveChangesAsync();
