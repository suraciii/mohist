...
public class SessionCommandContractTests
{
    ...
    public void CompactRequestAndResult_HaveSourceIndependentWireShape()
    {
        ...
        Assert.Equal(
            ["command", "operationId", "processGeneration", "runnerId", "runtime", "runtimeSessionId", "sessionId", "workDir"],
    ...
    public void ResetRequestAndResult_CarryExpectedAndReplacementRuntimeSessionIds()
    {
        ...
        var requestJson = JSON.SerializeToElement(request);
        Assert.Equal(
            ["command", "expectedRuntimeSessionId", "operationId", "processGeneration", "runnerId", "runtime", "runtimeSessionId", "sessionId", "workDir"],
            PropertyNames(requestJson));
    ...
    [InlineData(SessionCommandError.RuntimeUnavailable, "runtime-unavailable")]
