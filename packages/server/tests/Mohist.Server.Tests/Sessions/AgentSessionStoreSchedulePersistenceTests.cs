...
/// transactional save path with schedule-bearing state: reload
...
/// with fake collaborators at the other seams — a recording
/// <see cref="IEventStore"/> and an in-proc dispatch signal. SQLite serializes
