...
public sealed class SlackReplyAnchorIngressSpecs : IAsyncLifetime
{
    ...
    private async Task<AgentConnection> CreateConnectionAsync()
    {
        ...
        {
            // The anchor assertions prove secret values never leak into the
            // dispatch context, so this family keeps its distinctive values.
            AppToken = "xapp-anchor-secret",
            BotToken = "xoxb-anchor-secret",
        });
