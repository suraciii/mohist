...
public sealed class AgentSessionFollowupConcurrencyFixture : IAsyncLifetime
{
    ...
    public IDbContextFactory<MohistDbContext> DbFactory =>
        new FollowupConcurrencyDbContextFactory(_dbOptions);
    ...
    {
        var connectionString = $"Data Source=followup-concurrency-{Guid.NewGuid():N};Mode=Memory;Cache=Shared";
...
internal sealed class FollowupConcurrencyDbContextFactory : IDbContextFactory<MohistDbContext>
{
    private readonly DbContextOptions<MohistDbContext> _options;

    public FollowupConcurrencyDbContextFactory(DbContextOptions<MohistDbContext> options) => _options = options;
