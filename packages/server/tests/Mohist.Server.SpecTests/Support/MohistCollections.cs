...
// assembly fixture. Keep every consumer in one non-parallel collection so a
// responder/reset cannot steal another class's expected API calls.
[CollectionDefinition("SharedSlackApi", DisableParallelization = true)]
