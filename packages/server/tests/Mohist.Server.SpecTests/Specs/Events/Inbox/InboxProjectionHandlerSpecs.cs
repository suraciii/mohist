...
public class InboxProjectionHandlerSpecs
{
    ...
    public async Task WorkflowStorePublishThenEventStoreReplay_DoesNotDuplicateInboxItem()
    {
        ...
        var runStore = new WorkflowRunStore(new TestDbContextFactory(database.Options), eventStore, new NullEventDispatchGrainFactory(), NullLogger<WorkflowRunStore>.Instance, NoopBackgroundTaskLauncher.Instance);
