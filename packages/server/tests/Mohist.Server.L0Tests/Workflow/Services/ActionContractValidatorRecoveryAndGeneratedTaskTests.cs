...
public partial class ActionContractValidatorTests
{
    ...
    [Fact]
    public void Validate_GeneratedAgentTaskMissingRequiredInput_UsesNestedTaskPath()
    {
    ...
    [Fact]
    public void Validate_GeneratedAgentTaskInputType_UsesNestedTaskPath()
    {
        var task = GeneratedTask("""
            {
              "uses": "mohist/pi",
    ...
    [Fact]
    public void Validate_GeneratedTaskRequiresUses()
    {
        var task = GeneratedTask("""{ "with": { "prompt": "implement" } }""");
    ...
    private static TaskDefinition GeneratedTask(string taskJson) =>
        new(
            "load-tasks",
            Uses: "mohist/task-list",
            With: With(
                ("path", JsonString("artifacts/changes/example/tasks.json")),
                ("task", JsonObject(taskJson))));

    private static ActionCatalog GeneratedCatalog(params ActionCatalogEntry[] generatedActions) =>
        new(
            [
                CreateAction(
                    "mohist/task-list",
