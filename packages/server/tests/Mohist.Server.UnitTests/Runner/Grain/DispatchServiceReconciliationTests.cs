...
public class DispatchServiceReconciliationTests : Mohist.Server.UnitTests.Workflow.WorkflowGrainTests
{
    public DispatchServiceReconciliationTests(Mohist.Server.UnitTests.Workflow.WorkflowGrainFixture fixture) : base(fixture) { }
