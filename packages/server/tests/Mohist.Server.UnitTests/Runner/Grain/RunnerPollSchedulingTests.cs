...
public class RunnerPollSchedulingTests : Mohist.Server.UnitTests.Workflow.WorkflowGrainTests
{
    public RunnerPollSchedulingTests(Mohist.Server.UnitTests.Workflow.WorkflowGrainFixture fixture) : base(fixture) { }
