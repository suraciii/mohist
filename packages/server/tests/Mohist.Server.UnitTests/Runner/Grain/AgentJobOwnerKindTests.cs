...
namespace Mohist.Server.UnitTests.Runner.Grain;

public class AgentJobOwnerKindTests : WorkflowGrainTests
{
    public AgentJobOwnerKindTests(WorkflowGrainFixture fixture) : base(fixture) { }
...
public class WorkDispatchSerializationTests
{
    private readonly WorkflowGrainFixture _fixture;

    public WorkDispatchSerializationTests(WorkflowGrainFixture fixture)
    {
        _fixture = fixture;
    }
