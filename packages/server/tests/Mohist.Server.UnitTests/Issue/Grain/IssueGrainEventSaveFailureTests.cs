...
namespace Mohist.Server.UnitTests.Issue.Grain;
...
/// </summary>
[Collection("MohistDb")]
public class IssueGrainEventSaveFailureTests
{
    private readonly MohistDbFixture _fixture;

    public IssueGrainEventSaveFailureTests(MohistDbFixture fixture)
    {
        _fixture = fixture;
    }
