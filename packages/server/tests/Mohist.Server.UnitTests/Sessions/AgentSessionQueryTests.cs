...
/// pattern already established by <c>MohistLocalWorkflowProfileTests</c>.
/// </summary>
...
public class AgentSessionQueryTests
{
    ...
    public async Task QueryByTriggerLabels_ResolvesSubscriptionTriggeredSessions()
    {
        ...
        {
            db.AgentSessions.Add(BuildRow("s_triggered", labels, createdAt: DateTime.UnixEpoch));
    ...
    public async Task ComputedColumns_PopulateFromStateJson_WithoutBackfill()
    {
        ...
        var state = JsonSerializer.Serialize(new
        {
            ...
            settings = new { },
            status = new { createdAt = DateTime.UnixEpoch },
        }, JSON.Options);
        await using (var db = fixture.CreateDbContext())
        {
