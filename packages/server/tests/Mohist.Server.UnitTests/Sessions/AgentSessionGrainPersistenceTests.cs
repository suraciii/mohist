...
public class AgentSessionGrainPersistSuccessTests : AgentSessionGrainPersistenceSpecsBase
{
    public AgentSessionGrainPersistSuccessTests(AgentSessionGrainFixture fixture) : base(fixture) { }
...
public class AgentSessionGrainPersistStateFailureTests : AgentSessionGrainPersistenceSpecsBase
{
    public AgentSessionGrainPersistStateFailureTests(AgentSessionGrainFixture fixture) : base(fixture) { }
    ...
    public async Task FlushForTestAsync_StateSaveFailure_PropagatesAndQuarantinesActivation()
    {
        ...
        // covered by IssueGrainEventSaveFailureTests, which constructs the
...
public class AgentSessionGrainPersistTranscriptFailureTests : AgentSessionGrainPersistenceSpecsBase
{
    public AgentSessionGrainPersistTranscriptFailureTests(AgentSessionGrainFixture fixture) : base(fixture) { }
...
public class AgentSessionGrainRecoveryTranscriptFailureTests : AgentSessionGrainPersistenceSpecsBase
{
    public AgentSessionGrainRecoveryTranscriptFailureTests(AgentSessionGrainFixture fixture) : base(fixture) { }
...
public class AgentSessionGrainDeactivationTests : AgentSessionGrainPersistenceSpecsBase
{
    public AgentSessionGrainDeactivationTests(AgentSessionGrainFixture fixture) : base(fixture) { }
