...
/// SQLite fixture (matches the established <c>InboxItemsMigrationTests</c>
...
/// </summary>
public class AgentLaunchLabelComputedColumnsMigrationTests
{
    private const string MigrationName = "20260629112745_AddAgentLaunchLabelComputedColumns";
    private static readonly DateTime Timestamp = new(2026, 7, 11, 12, 0, 0, DateTimeKind.Utc);
    ...
    public async Task DatabaseMigrate_PopulatesComputedColumnsWithoutBackfill()
    {
        ...
        var stateJson = System.Text.Json.JsonSerializer.Serialize(new
        {
            ...
            settings = new { },
            status = new { createdAt = Timestamp },
        ...
        await ctx.Database.ExecuteSqlRawAsync(
            ...
            "s_no_backfill", stateJson, "opened", Timestamp);
