...
[Service]
Type=simple
WorkingDirectory=/home/mohist/repos/mohist
ExecStart=dotnet run --project /home/mohist/repos/mohist/packages/server/src/Mohist.Server/Mohist.Server.csproj -- --urls http://127.0.0.1:3456
Restart=on-failure
...
";
        ...
        Assert.Equal("/home/mohist/repos/mohist", result.WorkingDirectory);
        Assert.Equal("dotnet run --project /home/mohist/repos/mohist/packages/server/src/Mohist.Server/Mohist.Server.csproj -- --urls http://127.0.0.1:3456", result.ExecStart);
