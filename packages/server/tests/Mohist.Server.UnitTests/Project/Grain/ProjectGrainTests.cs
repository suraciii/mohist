...
namespace Mohist.Server.UnitTests.Project.Grain;

public class ProjectGrainTests : IClassFixture<WorkflowGrainFixture>
{
    private readonly WorkflowGrainFixture _fixture;
    private readonly IGrainFactory _grains;

    public ProjectGrainTests(WorkflowGrainFixture fixture)
    {
        _fixture = fixture;
