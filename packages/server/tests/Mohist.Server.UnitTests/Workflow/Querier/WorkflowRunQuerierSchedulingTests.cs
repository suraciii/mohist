...
/// </summary>
[Collection("MohistDb")]
public class WorkflowRunQuerierSchedulingTests
{
    private readonly MohistDbFixture _fixture;

    public WorkflowRunQuerierSchedulingTests(MohistDbFixture fixture)
    {
        _fixture = fixture;
    }
        ...
        string? assignedWorkerId)
    {
        ...
        run.Assignment = assignedWorkerId is null
            ? null
            : new WorkflowAssignment(assignedWorkerId, DateTimeOffset.UnixEpoch);
