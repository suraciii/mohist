...
/// <c>WorkflowGrainTests</c> abstract base class so helpers can be called
...
public static class WorkflowGrainTestHelpers
{
    ...
    public static async Task<(WorkDispatch Work, string RunnerId)> PollWorkAsync(IGrainFactory grains, string connectionString, string runnerId, string workflowId)
    {
        ...
        // instance helper in WorkflowGrainTests but is currently unused — callers
        // use the instance helper which has fixture access for the service provider.
        throw new NotSupportedException(
            "Static PollWorkAsync requires a service provider for DispatchService; use the WorkflowGrainTests instance helper instead.");
    }
    ...
    public static async Task SeedWorkflowTemplateAsync(string connectionString, string workflowId, WorkflowDefinition definition, string? projectId = null)
    {
        ...
        else
        {
            ...
            existingTemplate.UpdatedAt = DateTimeOffset.UnixEpoch;
        }
        ...
        else
        {
            ...
            projectProfile.UpdatedAt = DateTimeOffset.UnixEpoch;
        }
