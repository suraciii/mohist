...
namespace Mohist.Server.L1Tests.Specs.Auth;
...
/// </summary>
[Trait("level", "L1")]
public sealed class OperatorCredentialMigrationSpecs(DefaultMohistIntegrationFixture fixture) : IClassFixture<DefaultMohistIntegrationFixture>
{
