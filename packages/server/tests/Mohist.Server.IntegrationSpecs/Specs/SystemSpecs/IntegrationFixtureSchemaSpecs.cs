...
namespace Mohist.Server.IntegrationSpecs.Specs.SystemSpecs;

[Collection("IntegrationMisc")]
public class IntegrationFixtureSchemaSpecs
{
    private readonly MohistIntegrationFixture _fixture;

    public IntegrationFixtureSchemaSpecs(MohistIntegrationFixture fixture)
    {
        _fixture = fixture;
    }

    [Fact]
    public async Task InitializeAsync_ClonesTheMigratedSchemaBeforeStartingTheHost()
    {
