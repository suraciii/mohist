...
namespace Mohist.Server.ComponentSpecs.Specs.Runner.Grain;

[Collection("RunnerGrain")]
public class DispatchServiceReconciliationSpecs : Mohist.Server.ComponentSpecs.Specs.Workflow.WorkflowGrainSpecs
{
    public DispatchServiceReconciliationSpecs(Mohist.Server.ComponentSpecs.Specs.Workflow.WorkflowGrainFixture fixture) : base(fixture) { }
