...
public class RunnerPollSchedulingSpecs : Mohist.Server.ComponentSpecs.Specs.Workflow.WorkflowGrainSpecs
{
    public RunnerPollSchedulingSpecs(Mohist.Server.ComponentSpecs.Specs.Workflow.WorkflowGrainFixture fixture) : base(fixture) { }
