...
namespace Mohist.Server.ComponentSpecs.Specs.SystemSpecs.Otel;
...
public class MohistOpenTelemetryRegistrationSpecs
{
    ...
    public void Enabled_ActivityListenerSeesActivityStartedWhileProviderIsAlive()
    {
        ...
        {
            ShouldListenTo = source => source.Name == "Mohist.Server.ComponentSpecs.Specs.SystemSpecs.Otel",
        ...
        using var activitySource = new ActivitySource("Mohist.Server.ComponentSpecs.Specs.SystemSpecs.Otel");
