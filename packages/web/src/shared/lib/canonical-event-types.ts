export const REVERSE_DNS_EVENT_TYPES = {
  ...
  IssueParentChanged: 'com.mohist.issue.parent-changed',
  IssueRepositoryChanged: 'com.mohist.issue.repository-changed',
  IssueCompositeStarted: 'com.mohist.issue.composite-started',
  IssueCompositeStatusChanged: 'com.mohist.issue.composite-status-changed',
