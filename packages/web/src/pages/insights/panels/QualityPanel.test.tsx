...
describe('QualityPanel', () => {
  ...
  it('renders exactly one QualityWindow sourced from data.window with formatWindowTitle', () => {
  ...
  it('uses the range-driven window span for the title across 7d / 30d / 90d', () => {
  ...
  it('renders the panel empty state when window.sampleCount is zero', () => {
    useQualityMetricsMock.mockReturnValue({
      data: makeQualityResponse({
