...
const sessionStatusPresentation: Partial<Record<SessionStatusKind, { label: string; className: string; dotClassName?: string; withDot?: boolean }>> = {
  active: {
    label: 'Active',
...
function StatusBadge({ kind }: { kind: SessionStatusKind }) {
