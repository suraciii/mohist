...
import { __resetShortcutHandlersForTesting, getShortcutHandler } from '../../../shared/lib/keyboard-shortcuts'
...
export function renderSettingsSearch(initialEntry = '/settings/scheduling') {
  return render(
...
export function renderSettingsSearchWithLocationSpy(initialEntry = '/settings/scheduling') {
  return render(
    <QueryClientProvider client={makeQueryClient()}>
      <MemoryRouter initialEntries={[initialEntry]}>
        <LocationSpy />
...
export function renderSettingsSearchWithProject(initialEntry = '/settings/scheduling') {
  return render(
    <QueryClientProvider client={makeQueryClient()}>
