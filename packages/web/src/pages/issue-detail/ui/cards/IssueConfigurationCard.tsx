...
export type IssueConfigurationCardIssue = Pick<Issue, 'number' | 'canStart' | 'blocker'> & {
...
export function IssueConfigurationCard({
  ...
  if (!issue.isBacklog) return null

  const content = (
    <div data-testid="prerequisite-configuration-controls">
