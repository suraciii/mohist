 ...
 */
import { AI_SETTINGS_DESCRIPTORS } from '@/pages/settings/ui/AiSettingsSection'
import { AGENT_RUNTIME_DESCRIPTORS } from '@/pages/settings/ui/AgentSettingsSection'
import { PREFERENCES_DESCRIPTORS } from '@/pages/settings/ui/PreferencesSection'
import { REPOSITORIES_DESCRIPTORS } from '@/pages/settings/ui/RepositoriesSection'
import { SYSTEM_DESCRIPTORS } from '@/pages/settings/ui/SystemSettingsSection'
import { TEMPLATES_DESCRIPTORS } from '@/pages/settings/ui/TemplatesSection'
import { WORKFLOW_DESCRIPTORS } from '@/pages/settings/ui/WorkflowProfilesSection'
