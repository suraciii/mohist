...
const dependencies: StepListDependencies = {
  ...
  requestChangesHook: () => useMutation<ApprovalFeedback, Error, { issueNumber: number, data: { stage: string, body: string, author?: string | null } }>({ mutationFn: async () => { throw new Error('not used') } }),
