import type { PrDeliveryMetadata } from '../model/pr-delivery'
import { extractPrDeliveryMetadata } from '../model/pr-delivery'
...
export function PrDeliveryIndicator({ metadata, className }: PrDeliveryIndicatorProps) {
  return (
    ...
    >
      ...
      <svg className="h-3 w-3 flex-shrink-0 opacity-70" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
        <path
          fillRule="evenodd"
...
export function findPublishViaPrMetadata(timeline: WorkflowTimeline | null | undefined): PrDeliveryMetadata | null {
  return findMergedPullRequestDeliveryMetadata(timeline)
}
