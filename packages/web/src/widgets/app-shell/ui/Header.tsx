  ...
  return (
    <>
      <header className="h-14 border-b bg-background flex items-center px-4 md:px-6 shrink-0">
        <h1 className="text-lg font-bold text-foreground tracking-tight">mohist</h1>
          ...
          {projects.length === 0 ? (
            ...
            <div className="relative">
              <Button
                ...
                className="flex items-center gap-1.5 text-sm text-foreground/80 hover:text-foreground font-medium px-2.5 py-1.5 min-h-[44px]"
              >
                <span>{currentProject?.name ?? 'Select project'}</span>
                <svg
                  className={`h-4 w-4 text-muted-foreground/70 transition-transform ${dropdownOpen ? 'rotate-180' : ''}`}
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
              ...
              {dropdownOpen && (
                <div className="absolute top-full left-0 mt-1 w-56 rounded-md border bg-background shadow-lg py-1 z-50">
                  {projects.map((project) => (
                    <Button
                      key={project.id}
                      variant="ghost"
                      onClick={() => handleSelect(project)}
                      className={`w-full justify-start text-left px-3 py-2 text-sm h-auto font-normal ${
                    ...
                    >
                      ...
                      <div className="text-xs text-muted-foreground/70 truncate mt-0.5">{project.path}</div>
                    </Button>
                  ))}
                  ...
                  <Button
                    ...
                    className="w-full justify-start text-left px-3 py-2 text-sm text-foreground/80 h-auto font-normal"
                  >
                    New Project
                  </Button>
                  ...
                  <Button
                    ...
                    className="w-full justify-start text-left px-3 py-2 text-sm text-red-600 hover:bg-red-50 h-auto font-normal"
                  >
                    Delete Project
                  </Button>
                </div>
        ...
        <div className="ml-auto hidden md:flex items-center gap-2">
          ...
          <Button
            variant="outline"
            className="inline-flex items-center gap-1.5 text-foreground/80 hover:bg-muted"
          ...
          <Button
            className="inline-flex items-center gap-1.5 bg-blue-600 hover:bg-blue-700 text-white min-h-[44px]"
