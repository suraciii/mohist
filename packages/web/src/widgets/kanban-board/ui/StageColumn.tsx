  ...
  return (
    <div className={`flex flex-col min-w-[280px] max-w-[320px] flex-1${isDone ? ' opacity-60' : ''}`}>
      <div className="mb-3 flex items-center gap-2 px-1">
        <span className={`inline-block h-2.5 w-2.5 rounded-full${isDone ? ' bg-gray-300' : ' bg-gray-400'}`} />
        <h2 className={`text-sm font-semibold uppercase tracking-wide${isDone ? ' text-gray-400 font-normal' : ' text-gray-700'}`}>{label}</h2>
      ...
      <div className={`flex-1 space-y-2 overflow-y-auto rounded-lg p-2 min-h-[120px]${isDone ? ' bg-gray-50/60' : ' bg-gray-100/60'}`}>
        {totalCount === 0 && (
