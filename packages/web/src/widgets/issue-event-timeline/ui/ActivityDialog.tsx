  ...
  return (
    <>
      <button
        ...
        className={
          triggerClassName ??
          'inline-flex items-center justify-center gap-1.5 min-h-11 min-w-11 sm:min-h-9 sm:min-w-0 rounded-md border border-gray-200 bg-white px-2.5 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-50'
        }
      >
      ...
      <Dialog open={open} onOpenChange={handleOpenChange}>
        ...
        >
          <DialogHeader className="border-b border-gray-200 px-4 py-3 sm:px-6">
