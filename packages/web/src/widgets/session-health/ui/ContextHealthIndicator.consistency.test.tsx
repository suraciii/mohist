...
import type { SessionCard as SessionCardType } from '@/widgets/coder-session/model/activity-cards'
import { ActiveSessionCard } from '@/widgets/coder-session/ui/SessionCard'
