    ...
    public void Render(JsonNode? data, MohistCliApi.TableShape shape, bool colorEnabled = true)
    {
        switch (shape)
        {
            ...
            case MohistCliApi.TableShape.AgentSessionTranscript:
                ...
                break;
            case MohistCliApi.TableShape.AgentJobList:
                RenderAgentJobList(data);
                break;
            case MohistCliApi.TableShape.AgentJobView:
                RenderAgentJobView(data);
                break;
            case MohistCliApi.TableShape.AgentHistoryList:
                RenderAgentHistoryList(data);
                break;
            ...
            case MohistCliApi.TableShape.AgentSubscriptionList:
                ...
                break;
            case MohistCliApi.TableShape.AgentSubscription:
                RenderAgentSubscription(data);
                break;
            case MohistCliApi.TableShape.WebhookSubscriptionList:
                RenderWebhookSubscriptionList(data);
                break;
            case MohistCliApi.TableShape.WebhookSubscription:
                RenderWebhookSubscription(data);
                break;
