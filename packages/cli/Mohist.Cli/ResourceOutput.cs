...
internal static class ResourceOutputCatalog
{
    ...
    public static ResourceDescriptor For(string? tableShape)
    {
        ...
        {
            MohistCliApi.TableShape.ProjectList or MohistCliApi.TableShape.Project => ["id", "name", "createdAt", "updatedAt", "repositories", "variables", "defaultRepository", "defaultExecutionConfig", "verificationCommand"],
            ...
            MohistCliApi.TableShape.WorkflowRunDetail => ["status", "issueRef", "workflowProfileId"],
            ...
            MohistCliApi.TableShape.WorkflowProfileDetail => ["projectId", "profileId", "name", "description", "sourceProvenance", "isBuiltIn", "definitionSource", "stages"],
