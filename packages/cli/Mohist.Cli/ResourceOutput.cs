...
internal static class ResourceOutputCatalog
{
    ...
    public static ResourceDescriptor For(string? tableShape)
    {
        ...
        IReadOnlyList<string> fields = shape switch
        {
            ...
            MohistCliApi.TableShape.Sessions => ["id", "workflowRunId", "sessionName", "runtimeSessionId", "runtime", "projectId", "issueNumber", "runnerId", "activity", "stage", "model", "workDir", "processPid", "createdAt", "startedAt", "lastDataAt", "completedAt", "failureReason", "exitCode", "eventSummary", "usage", "interruption", "interruptionHistory"],
            MohistCliApi.TableShape.SessionMetadata => ["id", "sessionName", "runtimeSessionId", "runtime", "activity", "model", "stage", "title", "createdAt", "completedAt", "eventSummary", "usage", "metadata", "currentTurnId", "inputs", "turns", "interruption", "interruptionHistory"],
            ...
            MohistCliApi.TableShape.AgentSessionShow =>
                ["sessionId", "agentId", "agentName", "runtimeSessionId", "runtime", "activity", "createdAt", "lastActivityAt", "resolvedModel", "appliedReasoningEffort", "failureCategory", "failureReason", "toolCallCount", "toolErrorCount", "origin", "targetId", "contextRefs", "usage", "recoveryAvailable", "currentTurnId", "inputs", "turns", "interruption", "interruptionHistory"],
            ...
            MohistCliApi.TableShape.AgentJobView => ["jobId", "status", "message", "output", "artifactUploadIds", "failureReason", "exitCode", "executionDefinition", "recoveryDeadlineAt", "interruption", "interruptionHistory"],
            ...
            MohistCliApi.TableShape.SessionShow =>
                ["id", "source", "runtimeSessionId", "runtime", "activity", "createdAt", "lastActivityAt", "model", "resolvedModel", "appliedReasoningEffort", "failureCategory", "failureReason", "toolCallCount", "toolErrorCount", "agentId", "agentName", "workflowRunId", "sessionName", "origin", "targetId", "contextRefs", "usage", "recoveryAvailable", "currentTurnId", "inputs", "turns", "recoveryHistory", "interruption", "interruptionHistory"],
            ...
            MohistCliApi.TableShape.ProjectTemplateShow => ["projectId", "profileId", "name", "description", "sourceProvenance", "isBuiltIn", "definitionSource", "agentAction", "agentRuntime"],
            ...
            MohistCliApi.TableShape.WorkflowRunDetail => ["status", "issueRef", "workflowProfileId", "agentAction", "agentRuntime"],
            ...
            MohistCliApi.TableShape.WorkflowProfileList => ["projectId", "profileId", "name", "description", "sourceProvenance", "isBuiltIn", "definitionSource", "agentAction", "agentRuntime"],
