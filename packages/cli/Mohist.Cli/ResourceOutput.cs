...
internal static class ResourceOutputCatalog
{
    ...
    public static ResourceDescriptor For(string? tableShape)
    {
        ...
        IReadOnlyList<string> fields = shape switch
        {
            ...
            MohistCliApi.TableShape.ProjectTemplateShow => ["projectId", "profileId", "name", "description", "sourceProvenance", "isBuiltIn", "definitionSource", "agentRuntime"],
            ...
            MohistCliApi.TableShape.WorkflowProfileList => ["projectId", "profileId", "name", "description", "sourceProvenance", "isBuiltIn", "definitionSource", "agentRuntime"],
