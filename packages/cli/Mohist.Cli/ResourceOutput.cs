...
internal static class ResourceOutputCatalog
{
    private static readonly IReadOnlyList<string> AgentFields =
        ["id", "projectId", "name", "avatar", "purpose", "description", "instructions", "agentConfig", "skills", "permissions", "allowedSubagentAgentIds", "maxConcurrentRuns", "status", "createdAt", "updatedAt", "readiness"];
