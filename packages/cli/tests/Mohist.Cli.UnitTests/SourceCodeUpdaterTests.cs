...
public class SourceCodeUpdaterTests
{
    ...
    public async Task UpdateAll_UpdatesCliThenContinuesWithRefreshedProcess()
    {
        ...
        {
            files.DeleteDirectory(tempRoot);
        }
    }
    ...
    {
        var tempRoot = "/test/mohist-update-all-continue";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
        WriteRunnerUnit(files, "/units");
    ...
    {
        var tempRoot = "/test/mohist-update-all-no-runner";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
    ...
    {
        var tempRoot = "/test/mohist-update-cli";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
    ...
    public async Task UpdateRunner_BuildsCurrentSourceAndRestarts()
    {
        ...
        var updater = SourceCodeUpdater.CreateWithDefaults(
            ...
            files,
            new MockEnvironmentVariableProvider(),
            new HttpClient(new SequenceHttpHandler(new ResponseSpec(HttpStatusCode.OK, BuildRunnerIdentityResponse("runner-1", "test-host", null, "online"), "application/json")))
            {
                BaseAddress = new Uri("http://localhost:3456"),
            },
            unitDir: "/units",
    ...
    {
        var tempRoot = "/test/mohist-update-all-fail1";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
        WriteRunnerUnit(files, "/units");
    ...
    {
        var tempRoot = "/test/mohist-update-all-fail1b";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
        WriteRunnerUnit(files, "/units");
    ...
    {
        var tempRoot = "/test/mohist-update-all-timeout";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
        WriteRunnerUnit(files, "/units");
    ...
    {
        var tempRoot = "/test/mohist-update-all-ctrlc";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
        WriteRunnerUnit(files, "/units");
    ...
    {
        var tempRoot = "/test/mohist-update-all-early-cancel";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
    ...
    {
        var tempRoot = "/test/mohist-update-all-restore-fail";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
        WriteRunnerUnit(files, "/units");
    ...
    {
        var tempRoot = "/test/mohist-verify-allpass";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
    ...
    {
        var tempRoot = "/test/mohist-verify-identity";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
    ...
    {
        var tempRoot = "/test/mohist-verify-runner";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
    ...
    {
        var tempRoot = "/test/mohist-verify-skills";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
        ...
        try
        {
            ...
            var emptyHome = "/test/mohist-verify-skills-home";
            files.CreateDirectory(emptyHome);
            try
            {
                var updater = SourceCodeUpdater.CreateWithDefaults(
                    stdout,
            ...
            {
                files.DeleteDirectory(emptyHome);
            }
        }
        finally
        {
    ...
    {
        var tempRoot = "/test/mohist-verify-webassets";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
    ...
    {
        var tempRoot = "/test/mohist-check-cli-pass";
        var files = new FakeFileSystem();
        var commands = new FakeCommandExecutor();
    ...
    {
        var tempRoot = "/test/mohist-check-cli-fail";
        var files = new FakeFileSystem();
        var commands = new FakeCommandExecutor();
    ...
    {
        var tempRoot = "/test/mohist-check-cli-missing";
        var files = new FakeFileSystem();
        var commands = new FakeCommandExecutor();
        var installer = new SystemdServiceInstaller(
            new StringWriter(),
    ...
    {
        var tempRoot = "/test/mohist-check-identity-pass";
        var files = new FakeFileSystem();
        var commands = new FakeCommandExecutor();
        commands.SetStdoutFor("git", _ => true, "abc123");
        var installer = new SystemdServiceInstaller(
    ...
    {
        var tempRoot = "/test/mohist-check-identity-warn";
        var files = new FakeFileSystem();
        var commands = new FakeCommandExecutor();
        commands.SetStdoutFor("git", _ => true, "newhash");
        var installer = new SystemdServiceInstaller(
    ...
    {
        var tempRoot = "/test/mohist-check-runner-pass";
        var files = new FakeFileSystem();
        var commands = new FakeCommandExecutor();
        var installer = new SystemdServiceInstaller(
            new StringWriter(),
    ...
    {
        var tempRoot = "/test/mohist-check-runner-fail";
        var files = new FakeFileSystem();
        var commands = new FakeCommandExecutor();
        var installer = new SystemdServiceInstaller(
            new StringWriter(),
    ...
    {
        var tempRoot = "/test/mohist-check-skills-pass";
        var files = new FakeFileSystem();
        files.AddFile(
    ...
    {
        var tempRoot = "/test/mohist-check-skills-warn";
        var files = new FakeFileSystem();
        var commands = new FakeCommandExecutor();
        var installer = new SystemdServiceInstaller(
            new StringWriter(),
    ...
    {
        var tempRoot = "/test/mohist-check-web-pass";
        var files = new FakeFileSystem();
        var commands = new FakeCommandExecutor();
        var installer = new SystemdServiceInstaller(
            new StringWriter(),
    ...
    {
        var tempRoot = "/test/mohist-check-web-fail";
        var files = new FakeFileSystem();
        var commands = new FakeCommandExecutor();
        var installer = new SystemdServiceInstaller(
            new StringWriter(),
    ...
    {
        var tempRoot = "/test/mohist-outcome-posted";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
        WriteManagedSkillAssets(files, tempRoot);
    ...
    {
        var tempRoot = "/test/mohist-outcome-unreachable";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
        WriteManagedSkillAssets(files, tempRoot);
    ...
    {
        var tempRoot = "/test/mohist-cancel-no-post";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
    ...
    {
        var tempRoot = "/test/mohist-outcome-webui";
        var files = new FakeFileSystem();
        WritePackagedSkillAssets(files, Path.Combine(tempRoot, ".publish", "cli", "skill-data"));
        WriteManagedSkillAssets(files, tempRoot);
