...
export function createSharedSessionFixture(
  ...
  options?: {
    newSessionId?: string
    sessionRecord?: { runtimeSessionId: string; runtime?: string | null; model?: string | null }
  },
) {
  ...
  serverConnection.nextEnsureWorkflowAgentSession = options?.sessionRecord ? { ...options.sessionRecord, workDir: "D:/fake/work" } : { runtimeSessionId: "shared-session-1", runtime: "opencode", workDir: "D:/fake/work" }
