...
import { opencodeAction, parseOpencodeInput } from "../src/actions/opencode.js"
...
function buildRuntime(args: BuildArgs = {}): BuildResult {
  ...
  const clientProxy = {
    ...
    session: { create: sessionCreate, prompt: sessionPrompt, abort: sessionAbort, get: sessionGet, messages: vi.fn(), status: vi.fn() },
  }
  ...
  return {
    deps,
    runtime,
    client: { sessionCreate, sessionPrompt, sessionAbort, sessionGet },
    subscription,
  }
}
