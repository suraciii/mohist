...
Repositories
  api-server
    path: /home/mohist/repos/openviking-api
    baseBranch: main
    role: backend-service
    workflow: backend-service.yaml

  sdk
    path: /home/mohist/repos/openviking-sdk
    baseBranch: main
    role: package-library
    workflow: package-library.yaml

  web-app
    path: /home/mohist/repos/openviking-web
    baseBranch: main
    role: frontend-app
    workflow: frontend-app.yaml

  docs
    path: /home/mohist/repos/openviking-docs
    baseBranch: main
    role: documentation
    workflow: docs.yaml
```
...
Detected repositories:
  [x] openviking-api       /home/mohist/repos/openviking-api
  [x] openviking-web       /home/mohist/repos/openviking-web
  [x] openviking-sdk       /home/mohist/repos/openviking-sdk
  [ ] unrelated-sandbox    /home/mohist/repos/unrelated-sandbox
...
mo workspace repo add api-server /home/mohist/repos/openviking-api --role backend-service --base main
mo workspace repo add sdk /home/mohist/repos/openviking-sdk --role package-library --base main
...
Explore context
  workspace: openviking-product
  repositories:
    api-server -> /home/mohist/repos/openviking-api
    sdk        -> /home/mohist/repos/openviking-sdk
    web-app    -> /home/mohist/repos/openviking-web
    docs       -> /home/mohist/repos/openviking-docs
```
...
Repository sdk is unavailable:
  path /home/mohist/repos/openviking-sdk does not exist
